...
void Tablerobot::cambiar_estado_tab(casilla inicio, casilla fin, Ajedrezbot& a)
{
    //PIEZAS COMIDAS
...
void Tablerobot::coronapeon(casilla inicio, casilla fin, Ajedrezbot& a)
{
    int pieza;
    ...
    case 3:
        if (celda[inicio.fila][inicio.columna]->getColor() == Pieza::BLANCA)
        {
            ...
            celda[fin.fila][fin.columna] = new Caballo(Pieza::NEGRA);
            //a.puntuacionNegras += 15;
        }
